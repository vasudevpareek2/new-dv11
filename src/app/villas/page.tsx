      ...
      <div className='container mx-auto px-4 py-16'>
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
            Each of our villas is designed to provide the ultimate in comfort and luxury. you're
            looking for a romantic getaway or a family vacation, we have the perfect space for you.
          </p>
        </div>
      ...
      <div className='bg-primary-50 py-16'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-gray-600 mb-8 max-w-2xl mx-auto'>
            Experience the perfect blend of luxury and comfort at Dolce Vita Pushkar. Contact us for
