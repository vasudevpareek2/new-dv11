...
export default function VillaRosa() {
  ...
  const galleryImages = [
    '/images/villas/rosa/gallery1.jpg',
    '/images/villas/rosa/gallery2.jpg',
    '/images/villas/rosa/gallery3.jpg',
    '/images/villas/rosa/gallery4.jpg',
  ];
      ...
      <div className='relative h-[60vh] w-full'>
        ...
        <div className='absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center'>
          <div className='text-center text-white px-4'>
            <h1 className='text-4xl md:text-6xl font-bold mb-4'>Villa Rosa</h1>
            <p className='text-xl md:text-2xl'>Romantic Getaway in Pushkar</p>
          </div>
        </div>
      </div>
          ...
          <div className='lg:col-span-2'>
            ...
            <div className='mb-12'>
              ...
              <p className='text-gray-600 mb-6 leading-relaxed'>
                Experience romance and tranquility in our elegant 2-bedroom Villa Rosa. Perfect for
                couples or small families, this villa offers a private pool, modern amenities, and a
                serene atmosphere for a perfect getaway.
              </p>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6 bg-gray-50 p-6 rounded-xl'>
                ...
                <div className='flex items-center'>
                  ...
                  <div>
                    ...
                    <p className='font-medium'>Up to 4</p>
                  </div>
                </div>
                <div className='flex items-center'>
