      ...
      <div className='container mx-auto px-4'>
        <div className='max-w-5xl mx-auto text-center mb-16'>
          ...
          <p className='text-lg text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed'>
            Nestled in the heart of Pushkar, Dolce Vita offers a luxurious retreat that perfectly
            blends modern comfort with traditional charm. Our villas are designed to provide an
            unforgettable experience for couples and families alike, with personalized services and
        ...
        <div className='grid md:grid-cols-3 gap-8'>
          {[
            ...
            <div
              key={index}
              className='text-center p-6 rounded-lg bg-primary-200 hover:bg-primary-300 transition-colors duration-300'
            >
