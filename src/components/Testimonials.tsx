...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    content:
      'Exceptional stay at Dolce Vita! The villas are beautifully designed with attention to detail. The staff was incredibly welcoming and made our stay memorable. The location is perfect - peaceful yet close to Pushkar attractions.',
    image:
  ...
  },
  {
    ...
    rating: 5,
    content:
      'A perfect blend of luxury and comfort. The private pool villa was stunning, and the service was impeccable. The staff went above and beyond to make our anniversary special. Highly recommended for a romantic getaway!',
    image:
  ...
  },
  {
    ...
    rating: 5,
    content:
      "The best hospitality we've experienced in a long time. The villas are spacious, clean, and beautifully decorated. The food was delicious, and the staff was always ready to help. Will definitely come back!",
    image:
  ...
  },
  {
    ...
    rating: 5,
    content:
      'An absolute gem in Pushkar! The property is stunning, and the service is top-notch. The staff arranged wonderful cultural experiences for us. The perfect place to experience Rajasthani hospitality at its finest.',
    image:
...
export default function Testimonials() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCurrentIndex(
        (prevIndex) => (prevIndex + 1) % (totalTestimonials - visibleTestimonials + 1)
      );
    }, 5000);
