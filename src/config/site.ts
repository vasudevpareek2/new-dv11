...
const siteConfig = {
  ...
  description:
    'Luxurious villas in the heart of Pushkar, offering an unforgettable experience of comfort and elegance.',
  ...
  seo: {
    ...
    defaultDescription:
      'Experience luxury and comfort at Dolce Vita Pushkar. Our villas offer the perfect blend of traditional charm and modern amenities for an unforgettable stay.',
  ...
  features: [
    ...
    },
    {
      name: 'Prime Location',
      description:
        'Situated in the heart of Pushkar, close to major attractions and local culture.',
      icon: 'map-marker-alt',
    },
    {
      name: 'Gourmet Dining',
      description:
        'Experience authentic Rajasthani cuisine and international dishes prepared by our expert chefs.',
      icon: 'utensils',
    },
  ],
  ...
  roomTypes: [
    {
      ...
      name: 'Villa Rosa',
      description:
        'A luxurious villa with a private pool and garden view, perfect for a romantic getaway.',
      price: 25000,
      size: '85 sqm',
      capacity: '2 Adults',
      image: '/images/villa-rosa.jpg',
      gallery: ['/images/villa-rosa-1.jpg', '/images/villa-rosa-2.jpg', '/images/villa-rosa-3.jpg'],
      features: [
        'Private Pool',
        'King Size Bed',
        'Garden View',
    ...
    },
    {
      ...
      name: 'Villa Azzurra',
      description:
        'Spacious villa with a stunning pool view and modern amenities for a comfortable stay.',
      price: 30000,
      size: '100 sqm',
  ...
  testimonials: [
    {
      ...
      rating: 5,
      content:
        "Our stay at Dolce Vita was absolutely magical! The villa was luxurious, the staff was incredibly attentive, and the location was perfect. We can't wait to come back!",
      image:
    ...
    },
    {
      ...
      rating: 5,
      content:
        'The perfect romantic getaway! The private pool was our favorite spot. The attention to detail in the villa was impressive, and the staff went above and beyond to make our anniversary special.',
      image:
    ...
    },
    {
      ...
      rating: 4,
      content:
        'Beautiful property with excellent service. The villa was spacious and clean, and the food was delicious. Would definitely recommend for a peaceful retreat.',
      image:
    ...
    },
    {
      ...
      rating: 5,
      content:
        "One of the best places we've stayed in India. The combination of luxury and authentic local experience was perfect. The staff arranged wonderful tours for us.",
      image:
